    ...
    <div class="d-flex">
        <div class="col-5">
            ...
            <div class="mb-3">
                ...
                <input name="name" type="text" class="form-control" id="name" value="{{ $clothes[0]->cloth_name }}" disabled>
            </div>
            ...
            <div class="mb-3">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" aria-label="Amount (to the nearest dollar)" value="{{ $clothes[0]->price }}" disabled>
                </div>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" aria-label="Amount (to the nearest dollar)" value="{{ $clothes[0]->category_name }}" disabled>
            </div>

            <!-- Країна виробник -->
            <div class="mb-3">
                <label for="supplier" class="form-label">Виробник</label>
                <input type="text" class="form-control" aria-label="Amount (to the nearest dollar)" value="{{ $clothes[0]->supplier_name }}" disabled>
            </div>
            ...
            <div class="mb-3">
                ...
                <textarea name="description" id="description" class="form-control" rows="4" disabled>{{ $clothes[0]->description }}</textarea>
            </div>
        </div>
        <div class="col-1">
        ...
        <div class="col-5">
            ...
            <form id="add-clothing-form" action="{{ route('storage.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <!-- Товар -->
                <input type="hidden" name="cloth_id" value="{{ $clothes[0]->cloth_id }}">
